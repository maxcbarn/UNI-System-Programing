    ...
    switch (line.addrMode) {
        case IMPLICIT:
            switch (line.instruction) {
                case LDREGTOREG:
                    d.registers8b.push_back(line.reg8b_dest);
                    d.registers8b.push_back(line.reg8b_src);
                    break;
                case PUSH:
                case POP:
                    d.registers16b.push_back(line.reg16b);
                    break;
                default:
        ...
        case INDIRECT_REGISTER:
            ...
            if (line.instruction == LDMEMTOREG)
                ...
                d.registers8b.push_back(line.reg8b_src);
            d.registersEsp.push_back(IX); // HL e tratado internamente pelo addressing type
            break;
        ...
        case INDEXED:
            ...
            if (line.instruction == LDMEMTOREG)
                ...
                d.registers8b.push_back(line.reg8b_src);
            d.registersEsp.push_back(line.regEsp);
