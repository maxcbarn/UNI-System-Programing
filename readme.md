...
- SystemArchitecture.hpp - Setup types for the architecture, enums for better organization of registers and important definitions for the project.
...
- AdressingTypes.hpp & AdressingTypes.cpp - This is the base class of the adpaters that will treat the adressing types, it's propurse is to recive the instructions get the data from the memory ou register send it to the FunctionalUnit recive the computing and store acording to the adressing type, it's a adapter (not finished)(Max)